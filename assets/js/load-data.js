...
function deleteMovieFromWatchlist(decodedUserId, movieId) {
  ...
  $.ajax({
    url: "/watchlist/" + decodedUserId + "/" + movieId,
    method: "DELETE",
    data: {
...
function deleteMovieFromFavorite(dUserId, movieId) {
  ...
  $.ajax({
    url: "/movie/favorite/" + dUserId + "/" + movieId,
    method: "DELETE",
    data: {
      user_id: dUserId,
      movie_id: movieId,
...
function deleteDirectorFromFavorite(deUserId, directorId) {
  ...
  $.ajax({
    url: "/director/favorite/" + deUserId + "/" + directorId,
    method: "DELETE",
    data: {
      user_id: deUserId,
      director_id: directorId,
...
$(document).ready(function () {
  ...
  $.ajax({
    url: "/full/movie/favorite/" + userId,
    method: "GET",
    success: function (response) {
...
$(document).ready(function () {
  ...
  $.ajax({
    url: "/full/director/favorite/" + userId,
    method: "GET",
    success: function (response) {
